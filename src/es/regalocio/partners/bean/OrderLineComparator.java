...
public class OrderLineComparator implements Comparator {
  ...
  public OrderLineComparator(String field, int direction) {
  ...
  public int compare(Object object1, Object object2) throws ClassCastException {
    if (direction == ORDER_DESC) {
      return -compare((OrderLineBean) object1, (OrderLineBean) object2);
    }

    return compare((OrderLineBean) object1, (OrderLineBean) object2);
  }

  public int compare(OrderLineBean object1, OrderLineBean object2) {
  ...
  public boolean equals(Object object1, Object object2) throws ClassCastException {
    return equals((OrderLineBean) object1, (OrderLineBean) object2);
  }

  public boolean equals(OrderLineBean object1, OrderLineBean object2) {
    if (field.equals(SORTABLE_FIELD[0])) {
