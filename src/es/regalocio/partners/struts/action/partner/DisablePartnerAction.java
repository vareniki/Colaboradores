...
public class DisablePartnerAction extends SuccessAction {
  ...
  public ActionForward executeChild(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    service.setEnableAccount(Integer.parseInt(request.getParameter("partner_id")), false);

    ActionMessages messages = new ActionMessages();
    messages.add(Globals.MESSAGE_KEY, new ActionMessage("partner.disabled"));
