...
public class EnableRetailOutletAction extends SuccessAction {
  ...
  public ActionForward executeChild(ActionMapping mapping, ActionForm form,
    ...
    service.setEnableAccount(Integer.parseInt(request.getParameter("user_id")), true);

    ActionMessages messages = new ActionMessages();
    messages.add(org.apache.struts.Globals.MESSAGE_KEY, new ActionMessage("retail.outlet.enabled"));
