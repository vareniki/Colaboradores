...
<html:xhtml />				
<app:errors title="update.distribution.network.errors.title" />

<html:form action="/update_distribution_network" styleClass="form-horizontal">
  ...
  <div class="form-group">
    <label class="col-sm-4 control-label">Transpasar datos al punto de venta:</label>
    <div class="col-sm-8">
      <div class="checkbox">
        <label>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      <div class="checkbox">
        <label>
          <html:checkbox property="disable_changepassword" value="true" />
          deshabilitar cambio de contrase&ntilde;a
        </label>
      </div>
      <div class="checkbox">
        <label>
  ...
  <hr><h5>DIRECCI&Oacute;N DE ENTREGA</h5><hr> 
  <div class="form-group">
  ...
  <hr><h5>DIRECCI&Oacute;N DE FACTURACI&Oacute;N</h5><hr>

  <div class="form-group">
    <label class="col-sm-4 control-label">Direcci&oacute;n:</label>
    <div class="col-sm-8">
      <html:text styleClass="form-control" property="fact_address" maxlength="64" />
    </div>
  </div>
  <div class="form-group">
    <label class="col-sm-4 control-label"></label>
