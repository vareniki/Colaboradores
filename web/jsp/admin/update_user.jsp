...
<p class="text-primary">Por favor, rellene los siguientes datos relativos al usuario, y as&iacute;gnele a dicho usuario al menos un perfil.</p>
<hr> 
<html:form action="/update_user" styleClass="form-horizontal">
